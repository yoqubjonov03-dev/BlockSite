...
schema_view = get_schema_view(        # bu schema_view barcha proyectlarda birhil yoziladi
    openapi.Info(
        title="API ",
        default_version="v1",
...
urlpatterns = [
    ...
    re_path(r'^swagger(?P<format>\.json|\.yaml)$', schema_view.without_ui(cache_timeout=0), name='schema-json'),     # bu url ozgarmas holda yoziladi
    path('', schema_view.with_ui('swagger', cache_timeout=0), name='schema-swagger-ui'),        # 1-url
